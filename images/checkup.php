...
$services[] = array("port" => "80",       "service" => "Web server",                  "ip" => "host.docker.internal") ;
$services[] = array("port" => "3306",     "service" => "MYSQL",                   "ip" => "host.docker.internal") ;
$services[] = array("port" => "22",       "service" => "Open SSH",                              "ip" => "host.docker.internal") ;
